...
namespace ppe
{
	public partial class pageConnection : Form
	{
		...
		public pageConnection() // connection 
		{
			InitializeComponent();
			ConnexionMySql.Connexion("root", "siojjr", "rallyeLecture", "172.16.0.184");
		...
		private void BtnConnection_Click(object sender, EventArgs e) 
		{
			...
			Enseignant enseignant = tEnseignant.ChargerUnEnseignant(tbLogin.Text, tbPassWord.Text); // regarde si l'enseignant existe
			if (enseignant != null)
			{
