...
namespace ppe
{
    class LesEleves
    {
        ...
        public List<Eleve> LoadCsv(PassWordType type,string nomfichier) // charge le csv des eleves
        {
        ...
        public void CreateCsvPasswordFile(string nomfichier) // créer le csv des eleves login + password
        {
