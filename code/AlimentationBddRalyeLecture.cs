...
namespace ppe
{
    public partial class AlimentationBddRalyeLecture : Form
    {
        ...
        {
            InitializeComponent();
            this.Text = "Alimentation des élèves";
            this.enseignant = new Enseignant(id, nom, prenom, login, hashPassWord); //créer l'enseignant qui c'est connecter
            
            
            ConnexionMySql.Connexion("root", "siojjr", "rallyeLecture", "172.16.0.184"); // connection a la bdd
            ...
            {
                cmbNiveau.Items.Add(liste.NiveauScolaire); // ajoute les niveau des classes dans la combobox
            }
